...
const FollowBtn = ({ following ,handleClick}) => {
  return (
    <button onClick={handleClick} className="w-full full-rounded relative inline-block bg-white border-none transition-all duration-100 shadow-md hover:bg-blue-500 hover:text-white hover:scale-105">
      {following ? (
